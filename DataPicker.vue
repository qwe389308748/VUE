      ...
      <div class="picker-body">
        ...
        <div class="picker-content">
          ...
          <div class="picker-days" >
            <div 
            v-for="data in showDay" 
            :key="data.getTime()"
            :class="{
                'other-month': !isCur(data).month,
                'is-select': isCur(data).select,
                'is-today': isCur(data).today,
                }"
            @click="onChooseDate(data)"
            >
            {{ data.getDate() }}
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    isCur(data){
      ...
      const { year, month, day } = this.getYearMonthDay(data);
        return {
